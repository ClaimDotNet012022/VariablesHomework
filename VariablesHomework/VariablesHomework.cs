...
namespace VariablesHomework
{
    ...
    public class Variables
    {
        ...
        public void Operators()
        {
            ...
            float f = 12.3f;
            float c = f - 7.43f;
            //Assert.IsTrue(c == 4.87000036f); // Make this pass
            Assert.IsTrue(c == 12.3f - 7.43f); // Make this pass
        ...
        public void Ranges()
        {
            ...
            Assert.IsTrue(float.MaxValue == 3.40282347E38f); // Make this pass
            Assert.IsTrue(float.MinValue == -3.40282347E38f); // Make this pass
            Assert.IsTrue(double.MaxValue == 1.7976931348623157E308); // Make this pass
            Assert.IsTrue(double.MinValue == -1.7976931348623157E308); // Make this pass
        }
        ...
        public void Conversion()
        {
            ...
            // double d = 15.5;
            // int c = d;
            // From int to double is a widening conversion, and the conversion can be implicit.
            // From double to int is a narrowing conversion, and the conversion must be explicit.
        }
