...
namespace VariablesHomework
{
    ...
    public class Variables
    {
        ...
        {
            Assert.IsTrue(5 * 5 == 25); // Make this pass
        ...
        public void Assignment()
        {
            ...
            d = 'c';
            Assert.IsTrue(d == 'c'); // Then make this pass
        ...
        public void Operators()
        {
            ...
            int v = 5;
            int x = v % 4;
            Assert.IsTrue(x == v % 4); // Make this pass

            int finalInt = 15;
            int divisionResult = 15 / 3;
            Assert.IsTrue(divisionResult == 15/3); // Make this pass
            ...
            orderOfOperations = 2 + 12 * (orderOfOperations * 3); //2 + 12 * 2
        ...
        public void Casting()
        {
            ...
            double d = 15.5; //Converts double (decimal) value to int
            int c = (int)d;
