...
namespace VariablesHomework
{
    ...
    public class Variables
    {
        ...
        public void Assignment()
        {
            ...
            Assert.IsTrue(c == 'd'); // Then make this pass
        ...
        public void Operators()
        {
            ...
            int z = 23456;
            z *= 3; // z = z*3
            Assert.IsTrue(z == 23456 * 3); // Make this pass
        ...
        public void Casting()
        {
            ...
            double d = 15.5;
            int c = (int)d; // coversion double to int value or whole number
            Assert.IsTrue(c == 15); // Make this pass

            string e = d.ToString();// d = 15.5 "15.5" (you can go backwards by using a double)
