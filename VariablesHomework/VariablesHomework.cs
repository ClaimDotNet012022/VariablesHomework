...
namespace VariablesHomework
{
    ...
    public class Variables
    {
        ...
        public void Operators()
        {
            ...
            bool d = false;
            bool e = !d;
            Assert.IsTrue(e == true/*Answer here*/); // Make this pass
            ...
            Assert.IsTrue(t == 70368/*Answer here*/); // Make this pass

            int z = 23456;
            z *= 3;
            Assert.IsTrue(z == 70368/*Answer here*/); // Make this pass
        ...
        public void Ranges()
        {
            ...
            Assert.IsTrue(double.MaxValue == 1.7E308/*Answer here*/); // Make this pass
            Assert.IsTrue(double.MinValue == 5.0E-324/*Answer here*/); // Make this pass
        }
        ...
        public void Overflow()
        {
            ...
            {
                Assert.IsTrue(int.MaxValue + 1 == 2147483647/*Answer here*/); // Make this pass
                Assert.IsTrue(int.MinValue - 1 == -2147483647/*Answer here*/); // Make this pass
                Assert.IsTrue(float.MaxValue + 1 == 3.4028235E+38/*Answer here*/); // Make this pass
                Assert.IsTrue(float.MinValue - 1 == -3.4028235E+38/*Answer here*/); // Make this pass
                Assert.IsTrue(double.MaxValue + 1 == 1.7E308/*Answer here*/); // Make this pass
                Assert.IsTrue(double.MinValue - 1 == 5.0E-324/*Answer here*/); // Make this pass
            }
        }
        ...
        public void Conversion()
        {
            int i = 13;
            double d = i;
            Assert.IsTrue(d == 13.0/*Answer here*/); // Make this pass
        ...
        public void Casting()
        {
            ...
            string e = d.ToString();
            Assert.IsTrue(e == 15.ToString()/*Answer here*/); // Make this pass
        }
